...
if [ ! -f env_props.sh ] ;then
  cp env_props.sh.sample_local env_props.sh
  cat <<EOF
=================================================
...
: ${PERISCOPE_HOSTNAME_RESOLUTION:=private}
...
-e "PERISCOPE_IDENTITY_SERVER_URL=http://$UAA_ADDR:8080" \
-e "PERISCOPE_CLIENT_ID=$PERISCOPE_CLIENT_ID" \
-e "PERISCOPE_CLIENT_SECRET=$PERISCOPE_CLIENT_SECRET" \
-e "PERISCOPE_HOSTNAME_RESOLUTION=$PERISCOPE_HOSTNAME_RESOLUTION" \
